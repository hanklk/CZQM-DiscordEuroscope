...
namespace DiscordEuroScope_Configuration
{
	...
	{
		this->discord_appid = "1383385204713984051";
		this->discord_presence_large_image_key = "czqm_logo";  // Keep your custom logo
		...
		for (int i = 0; i < 7; i++)
		{
			...
			this->states[i].presence_large_image_key = "czqm_logo";
			this->states[i].presence_large_image_text = "Moncton/Gander FIR";
